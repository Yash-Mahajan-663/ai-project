    ...
    >
      <div className="flex flex-col gap-2 relative">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-5xl font-outfit text-slate-900 leading-none">System <span className="text-blue-600 font-medium">Control</span></h1>
        </div>
        <p className="text-[11px] text-slate-500 uppercase tracking-[0.3em] pl-1">Global configuration & system parameters</p>
        <div className="absolute -top-10 right-0 opacity-[0.03] text-8xl select-none pointer-events-none uppercase font-outfit">SETTINGS</div>
      </div>
          ...
          >
            <div className="flex items-start gap-6">
              ...
              <div className="flex flex-col gap-1.5">
                <h3 className="text-lg text-slate-900 tracking-tight font-outfit">{setting.title}</h3>
                <p className="text-xs text-slate-500 leading-relaxed tracking-tight max-w-[200px]">{setting.desc}</p>
              </div>
            </div>
      ...
      {/* Decorative Text */}
      <div className="fixed -bottom-10 -right-10 opacity-[0.02] text-[15rem] select-none pointer-events-none uppercase font-outfit">SYSTEM</div>
    </motion.div>
  );
}
