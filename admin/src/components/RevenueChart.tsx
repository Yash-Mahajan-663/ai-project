      ...
      <div className="flex items-center justify-between mb-12 relative z-10">
        <div className="flex flex-col gap-2">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-3xl font-extralight text-slate-800 tracking-tight font-outfit">Revenue <span className="text-blue-600 font-light">Analytics</span></h2>
          </div>
          <p className="text-sm text-slate-400 font-light uppercase tracking-[0.2em] ml-1">Live stream performance</p>
        </div>
        <button className="flex items-center gap-2 px-5 py-2.5 bg-white/60 border border-white rounded-2xl text-xs font-light text-slate-800 uppercase tracking-widest hover:bg-white transition-all shadow-sm">
          Last 30 Days
      ...
      <div className="flex-1 min-h-[400px] w-full relative z-10">
        {isEmpty ? (
          <div className="flex flex-col items-center justify-center h-full gap-4">
            ...
            <p className="text-xs text-slate-300 font-light uppercase tracking-widest">No revenue data yet</p>
            <p className="text-[10px] text-slate-200 font-light">Confirmed bookings with price will appear here</p>
          </div>
        ) : (
